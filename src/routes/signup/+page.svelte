...
<svelte:head><title>Sign up · Planet</title></svelte:head>
...
<div class="auth-wrap">
	<div class="auth-card">
		...
		<form method="POST" onsubmit={() => (submitting = true)}>
			...
			<label>
				<span>Invitation token <span class="opt">(optional)</span></span>
				<textarea name="invitation" rows="2"></textarea>
			</label>
			<Button type="submit" colorScheme="teal" size="lg" loading={submitting}>Start for free</Button>
		</form>
